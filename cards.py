...
POSITIONS = [
    "Центрфорвард (ST) — Классическая девятка, играет замыкающим",
    "Правый вингер (RW) — Быстрый крайний нападающий с дриблингом",
    "Левый вингер (LW) — Смещается в центр под удар с рабочей ноги",
    "ЦАП (CAM) — Гениальный плеймейкер, раздает ассисты",
    "ЦП (CM) — Бокс-ту-бокс, выжигает поле от штрафной до штрафной",
    "ЦОП (CDM) — «Волнорез», разрушает любые атаки соперника",
    "Крайний защитник (LB/RB) — Латераль с бешеными легкими",
    "Центральный защитник (CB) — Скала в обороне, снимает весь верх",
    "Вратарь (GK) — «Паук» на линии ворот с молниеносной реакцией",
    "Ложная девятка (CF) — Опускается в глубину и запутывает защитников"
]
